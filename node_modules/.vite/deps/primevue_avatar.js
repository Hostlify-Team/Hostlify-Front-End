...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  return openBlock(), createElementBlock("div", {
    ...
    renderSlot(_ctx.$slots, "default", {}, () => [
      $props.label ? (openBlock(), createElementBlock("span", _hoisted_1, toDisplayString($props.label), 1)) : $props.icon ? (openBlock(), createElementBlock("span", {
        key: 1,
...
// dep:primevue_avatar
var primevue_avatar_default = script;
export {
