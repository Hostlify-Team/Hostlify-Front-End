...
var _hoisted_8 = createBaseVNode("span", { class: "p-dropdown-filter-icon pi pi-search" }, null, -1);
var _hoisted_9 = {
  role: "status",
  "aria-live": "polite",
...
var _hoisted_10 = ["id"];
var _hoisted_11 = ["id"];
var _hoisted_122 = ["id", "aria-label", "aria-selected", "aria-disabled", "aria-setsize", "aria-posinset", "onClick", "onMousemove"];
var _hoisted_13 = {
  key: 0,
          ...
          default: withCtx(() => [
            $data.overlayVisible ? (openBlock(), createElementBlock("div", mergeProps({
              ...
              $props.filter ? (openBlock(), createElementBlock("div", _hoisted_5, [
                ...
                createBaseVNode("span", _hoisted_9, toDisplayString($options.filterResultMessageText), 1)
                    ...
                    createBaseVNode("ul", {
                      ...
                      (openBlock(true), createElementBlock(Fragment, null, renderList(items, (option, i) => {
                        return openBlock(), createElementBlock(Fragment, {
                          ...
                          ], 12, _hoisted_11)) : withDirectives((openBlock(), createElementBlock("li", {
                            key: 1,
                            id: $options.id + "_" + $options.getOptionIndex(i, getItemOptions),
                            style: normalizeStyle({ height: itemSize ? itemSize + "px" : void 0 }),
                      ...
                      $data.filterValue && (!items || items && items.length === 0) ? (openBlock(), createElementBlock("li", _hoisted_13, [
                        renderSlot(_ctx.$slots, "emptyfilter", {}, () => [
                          createTextVNode(toDisplayString($options.emptyFilterMessageText), 1)
                        ])
                      ])) : !$props.options || $props.options && $props.options.length === 0 ? (openBlock(), createElementBlock("li", _hoisted_14, [
                        renderSlot(_ctx.$slots, "empty", {}, () => [
                          createTextVNode(toDisplayString($options.emptyMessageText), 1)
                        ])
                      ])) : createCommentVNode("", true)
                    ], 14, _hoisted_10),
                    !$props.options || $props.options && $props.options.length === 0 ? (openBlock(), createElementBlock("span", _hoisted_15, toDisplayString($options.emptyMessageText), 1)) : createCommentVNode("", true),
                    createBaseVNode("span", _hoisted_16, toDisplayString($options.selectedMessageText), 1)
                  ]),
                  _: 2
                }, [
                  _ctx.$slots.loader ? {
...
//# sourceMappingURL=chunk-WH5EZTU6.js.map
